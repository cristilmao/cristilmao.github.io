...
(function () {
        ...
        var links = [
            {
				...
				name: 'instagram',
                link: 'https://www.instagram.com/flowqx/'
            },
                
            {
                name: 'YouTube',
                link: 'https://www.youtube.com/watch?v=GsaIcqsOcPo'
            },
                
            {
                name: 'Github',
                link: 'https://github.com/Cristixd646'
            },


			{
                name: '???',
                link: 'https://www.youtube.com/watch?v=yUGZwlLoZh0'
            }
        ];
    ...
    (function () {
        $.getJSON('https://api.ipgeolocation.io/ipgeo?apiKey=bc46132fb5914b928799bfe862a1258d', function (data) {
            ...
            writeLine(["Authenticating...", "Granting access to <span style='font-size: 14px; color: #06d;'>[the skids site]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, <i style='color: #0f0'>" +  ((data.ip) ? data.ip : usernames[Math.floor(Math.random()*usernames.length)]) 
                    ...
                    writeLine(["<i style='color: #F62459'@davydxan/Telegram</i>"], 120, 500, function () {
